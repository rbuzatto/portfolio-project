    ...
    <section className="about">
        {/* <div className="about__intro">
            <div className="about__wrapper">
                <div className="about__title about__title--left"><span className="about__title-bg-layout">About</span></div>
                <div className="about__line"></div>
                <div className="about__title about__title--right">Me.</div>
            </div>
        </div> */}
        <Intro firstText='About' secondText='me.' />
        <div>
